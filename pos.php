...
<head>
  ...
  <title>POS | AllShirt Commercial Outlet</title>
            ...
            <div class="mb-3 text-blue-gray-700 px-3 pt-2 pb-3 rounded-lg bg-blue-gray-50">
              <div class="flex text-lg font-semibold">
                ...
                <div class="flex text-right">
                  ...
                  <input x-bind:value="numberFormat(cash)" x-on:blur="updateCash($event.target.value)" onClick="this.select();" type="text" class="w-28 text-right bg-white shadow rounded-lg focus:bg-white focus:shadow-lg px-2 focus:outline-none">
                </div>
              </div>
              <hr class="my-2">
